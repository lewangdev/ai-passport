...
- Added the Pocket Toolkit six-in-one example: identity, explicitly offline conversation, productivity tools, random maze, vocabulary and pixel pet, with shared rewards, local saves and host tests. See the [application guide](../README.md).
