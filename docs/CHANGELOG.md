...
- Added the offline Pocket Dagou Tap adaptation with default sample packs, pitch/piano modes, synthesized rhythm, animated characters, geometric feedback and persistent settings. See [the application guide](dagou-tap.md) for controls, original-media attribution and adaptation limits.
