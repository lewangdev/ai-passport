...
static void describe(void){
    ...
    case P_PAY:title("今日工资条","Today's payslip");view.kind=NM_VIEW_TEXT;snprintf(view.body,sizeof(view.body),tr("基本工资 %u\n绩效奖金 %u\n其他奖励 %u\n今日消费 %u\n净收益 %+ld","Base pay %u\nTarget bonus %u\nOther rewards %u\nExpenses %u\nNet %+ld"),receipt.salary,receipt.target_bonus,receipt.game_bonus,receipt.expenses,(long)receipt.net);option("回家，继续自己的生活","Go home for the evening");break;
    }
